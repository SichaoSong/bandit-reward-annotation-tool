...
- CSVには未評価動画も含め、ランダム化後の提示順 `presentation_order` も保存
...
5. 動画を再生し、1〜7で採点します。
6. 理由を50文字以上入力します。
7. 「次へ」でブラウザ内に保存して次の動画へ進みます。
8. 前の動画を修正したい場合は「前へ」で戻り、修正後に「次へ」または「保存」を押します。
9. CSVとしてローカル保存したいタイミングで「保存」を押します。最後の動画では「保存」で作業内容を確定します。
